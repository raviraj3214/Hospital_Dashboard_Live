...
class Medicines extends Component {
    ...
    handleDeleteMedicine = async (medicine_id) => {
        ...
        if (confirmDelete) {
            // try {
            //     const response = await fetch(`http://194.163.40.231:8080/Medicine/delete/${medicine_id}`, {
            //         method: "DELETE",
            //         headers: {
            ...
            //     this.getAllMedicines();
            //     alert("The medicine has been deleted.");
            // } catch (error) {
            //     console.error('Deletion failed:', error);
            //     alert("Deletion failed");
            // }
            axios.post(`http://194.163.40.231:8080/Medicine/delete-By/`,
            ...
            .then((response) => {
                ...
                this.getAllMedicines();
                alert("The medice has been deleted.");
            })
            .catch((error) => {
                console.error('Deletion failed:', error);
                alert("Deletion failed");
